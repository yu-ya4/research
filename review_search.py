...
if __name__ == '__main__':
    ...
    saved_restaurants_urls = get_restaurants_url_not_in_database('where pal="osaka"')
    ...
    # # exit()
    # restaurant_htmls, restaurant_urls = searcher.search_for_restaurants('おばんざい', 'kyoto', 'A2601', '', 'RC', 'RC21', 'RC2199', '')
    # restaurants = searcher.parse_restaurants(restaurant_htmls, restaurant_urls)
    # searcher.save_restaurants(restaurants)
    # exit()
    ...
    restaurant_urls = searcher.get_restaurant_urls_without_reviews_from_db(10, 0)
